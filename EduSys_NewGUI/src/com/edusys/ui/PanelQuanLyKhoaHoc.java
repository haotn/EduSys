...
import com.edusys.helper.DateLabelFormatter;
...
public class PanelQuanLyKhoaHoc extends javax.swing.JPanel {
    ...
    public void generateDatePicker() {
        ...
        txtNgayKhaiGiang.setLayout(new BorderLayout());
        txtNgayKhaiGiang.add(datePicker, BorderLayout.CENTER);
...
//        datePickerModel.setDate(year, month, day);
    ...
    private void initComponents() {
        ...
        pnlFormKhoaHoc.add(txtNgayTao, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 120, 320, 30));
        ...
        pnlFormKhoaHoc.add(txtChuyenDe, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 40, 320, 30));

        txtHocPhi.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        pnlFormKhoaHoc.add(txtHocPhi, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 80, 320, 30));

        txtNguoiTao.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        pnlFormKhoaHoc.add(txtNguoiTao, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 120, 320, 30));

        txtThoiLuong.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        pnlFormKhoaHoc.add(txtThoiLuong, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 80, 320, 30));

        txtNgayKhaiGiang.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        pnlFormKhoaHoc.add(txtNgayKhaiGiang, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 30, 320, 30));
        ...
        cboLocChuyenDe.setFont(new java.awt.Font("SansSerif", 1, 14));
    ...
    public static javax.swing.JComboBox<String> cboLocChuyenDe;
...
//        int day = Integer.parseInt(date.substring(8, 10));
    ...
    public KhoaHoc getForm() {
        ...
        kh.setNgayKG(XDate.toDate(XDate.toString(datePickerModel.getValue(), "yyyy-MM-dd"), "yyyy-MM-dd"));
    ...
    public void updateStatus() {
        ...
        txtChuyenDe.setText(chuyenDe.getTenCD());
        txtHocPhi.setText(String.valueOf((long) chuyenDe.getHocPhi()));
...
//        }).start();
    ...
    public void fillTable() {
        ...
        try {
            ...
            for (KhoaHoc kh : list) {
                model.addRow(new Object[]{kh.getMaKH(), kh.getMaCD(), (long) kh.getHocPhi(), kh.getThoiLuong(), XDate.toString(kh.getNgayKG(), "dd/MM/yyyy"), XDate.toString(kh.getNgayTao(), "dd/MM/yyyy"), kh.getMaNV(), kh.getGhiChu()});
            }
        } catch (Exception e) {
        }
    }
    ...
    public boolean check() {
        if (!datePickerModel.getValue().after(new Date())) {
            MsgBox.alert(this, "Ngày khai giảng phải sau ngày hiện tại!");
            return false;
        }
        return true;
    }
