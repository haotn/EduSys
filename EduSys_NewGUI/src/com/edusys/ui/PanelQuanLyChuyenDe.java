...
import com.edusys.dao.HocPhiDAO;
...
public class PanelQuanLyChuyenDe extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnGioiHanHocPhi = new javax.swing.JButton();
        ...
        txtTimCD.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtTimCDFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtTimCDFocusLost(evt);
            }
        });
        txtTimCD.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtTimCDKeyReleased(evt);
            }
        });
        ...
        btnGioiHanHocPhi.setBackground(new java.awt.Color(255, 255, 255));
        btnGioiHanHocPhi.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        btnGioiHanHocPhi.setForeground(new java.awt.Color(51, 51, 51));
        btnGioiHanHocPhi.setText("Đặt lại giới hạn học phí");
        btnGioiHanHocPhi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGioiHanHocPhiActionPerformed(evt);
            }
        });
        pnlFormChuyenDe.add(btnGioiHanHocPhi, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 290, -1, -1));
    ...
    private void btnGioiHanHocPhiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGioiHanHocPhiActionPerformed
        // TODO add your handling code here:
        datGioiHanHocPhi();
    }//GEN-LAST:event_btnGioiHanHocPhiActionPerformed

    private void txtTimCDFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTimCDFocusGained
        // TODO add your handling code here:
        focusGained();
    }//GEN-LAST:event_txtTimCDFocusGained

    private void txtTimCDFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtTimCDFocusLost
        // TODO add your handling code here:
        focusLost();
    }//GEN-LAST:event_txtTimCDFocusLost

    private void txtTimCDKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtTimCDKeyReleased
        // TODO add your handling code here:
        fillTable();
    }//GEN-LAST:event_txtTimCDKeyReleased


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnCapNhat;
    private javax.swing.JButton btnFirst;
    private javax.swing.JButton btnGioiHanHocPhi;
    ...
    public void focusGained() {
        if (txtTimCD.getText().equals("Tìm kiếm chuyên đề")) {
            txtTimCD.setText("");
        }
        txtTimCD.setForeground(Color.black);
    }

    public void focusLost() {
        if (txtTimCD.getText().equals("")) {
            txtTimCD.setText("Tìm kiếm chuyên đề");
            txtTimCD.setForeground(new Color(102, 102, 102));
        }
    }
    ...
    void fillTable() {
        ...
        try {
            List<ChuyenDe> list;
            if (txtTimCD.getText().equals("") || txtTimCD.getText().equals("Tìm kiếm chuyên đề")) {
                list = dao.selectAll();
            } else {
                list = dao.selectByKeyword(txtTimCD.getText());
            }
    ...
    void setForm(ChuyenDe cd) {
        ...
        txtHocPhi.setText(String.valueOf((long) cd.getHocPhi()));
    ...
    public boolean checkForm() {
        ...
        if (txtMaChuyenDe.getText().equals("") || txtTenChuyenDe.getText().equals("") || txtThoiLuong.getText().equals("")
            ...
            return false;
        } else if (!(txtMaChuyenDe.getText()).matches("CD[0-9]{1,5}")) {
    ...
    public void datGioiHanHocPhi() {
        HocPhiDAO hpDAO = new HocPhiDAO();
        HocPhi hp = hpDAO.selectHocPhi();
        NhanVienDAO nvDAO = new NhanVienDAO();
        NhanVien nv = nvDAO.selectById(hp.getMaNV());
        String hocPhi = MsgBox.prompt(this, "Giới hạn học phí hiện tại là: " + (long) hp.getHocPhi() + "\n Do " + nv.getHoTen() + " (" + hp.getMaNV()
                + ") đổi vào ngày " + XDate.toString(hp.getNgayDoi(), "dd-MM-yyyy") + "\n Nhập giới hạn học phí phía dưới nếu bạn muốn thay đổi!");
        if (hocPhi != null) {
            if (hocPhi.equals("")) {
                JOptionPane.showMessageDialog(this, "Bạn chưa nhập học phí!", "Error", 1);
                btnGioiHanHocPhi.doClick();
            } else if (!hocPhi.matches("[0-9]{1,}")) {
                JOptionPane.showMessageDialog(this, "Học phí không hợp lệ, chỉ chấp nhận giá trị số!", "Error", 1);
                btnGioiHanHocPhi.doClick();
            } else {
                if (MsgBox.confirm(this, "Bạn có chắc muốn thay đổi giới hạn học phí không?")) {
                    hp.setHocPhi(Float.parseFloat(hocPhi));
                    hp.setMaNV(Auth.user.getMaNV());
                    hp.setNgayDoi(XDate.toDate(XDate.toString(new Date(), "yyyy-MM-dd"), "yyyy-MM-dd"));
                    try {
                        hpDAO.update(hp);
                        //MsgBox.alert(this, "Đổi giới hạn học phí thành công!");
                    } catch (Exception e) {
                        Logger.getLogger(ChuyenDeDAO.class.getName()).log(Level.SEVERE, null, e);
                    }
