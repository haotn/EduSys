...
//JOptionPane.showMessageDialog(this, "Lỗi truy vấn dữ liệu!");
    ...
    public void insert() {
        NhanVien nv = getForm();
        String mk2 = String.valueOf(pwdXacNhanMatKhau.getPassword());
        int space = txtHoTenNV.getText().trim().lastIndexOf("");
        if (!mk2.equals(nv.getMatKhau())) {
            ...
            MsgBox.alert(this, "Vui lòng nhập đầy đủ họ tên nhân viên!");
        } else {
            try {
                dao.insert(nv);
                this.fillTable();
